...
func TestNames(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Ami", "AMI", "ami", "ami", "ami"},
		{"Acm", "ACM", "acm", "acm", "acm"},
		{"AcmEndpoint", "ACMEndpoint", "acmEndpoint", "acm_endpoint", "acmendpoint"},
		...
		{"SnapshotARNs", "SnapshotARNs", "snapshotARNs", "snapshot_arns", "snapshotarns"},
		{"MemberClustersOutpostARNs", "MemberClustersOutpostARNs", "memberClustersOutpostARNs", "member_clusters_outpost_arns", "memberclustersoutpostarns"},
		...
		{"HTTPSPort", "HTTPSPort", "httpsPort", "https_port", "httpsport"},
		{"HTTPPort", "HTTPPort", "httpPort", "http_port", "httpport"},
		{"HttpPort", "HTTPPort", "httpPort", "http_port", "httpport"},
		{"HttpError", "HTTPError", "httpError", "http_error", "httperror"},
		{"HTTPError", "HTTPError", "httpError", "http_error", "httperror"},
		{"HttpStatus", "HTTPStatus", "httpStatus", "http_status", "httpstatus"},
		{"HTTPStatus", "HTTPStatus", "httpStatus", "http_status", "httpstatus"},
		{"HTTPSSupport", "HTTPSSupport", "httpsSupport", "https_support", "httpssupport"},
		{"HttpsSupport", "HTTPSSupport", "httpsSupport", "https_support", "httpssupport"},
		{"HttpSupport", "HTTPSupport", "httpSupport", "http_support", "httpsupport"},
		{"HTTPSupport", "HTTPSupport", "httpSupport", "http_support", "httpsupport"},
		{"Id", "ID", "id", "id", "id"},
		{"ID", "ID", "id", "id", "id"},
		...
		{"Ui", "UI", "ui", "ui", "ui"},
		{"UI", "UI", "ui", "ui", "ui"},
		{"humanTaskUiArn", "HumanTaskUIARN", "humanTaskUIARN", "human_task_ui_arn", "humantaskuiarn"},
		{"humanTaskUIArn", "HumanTaskUIARN", "humanTaskUIARN", "human_task_ui_arn", "humantaskuiarn"},
		{"URI", "URI", "uri", "uri", "uri"},
		{"Uri", "URI", "uri", "uri", "uri"},
		{"URIRef", "URIRef", "uriRef", "uri_ref", "uriref"},
		{"UriRef", "URIRef", "uriRef", "uri_ref", "uriref"},
		{"Vlan", "VLAN", "vlan", "vlan", "vlan"},
		{"vpce", "VPCE", "vpce", "vpce", "vpce"},
		{"vpc", "VPC", "vpc", "vpc", "vpc"},
		{"Vpc", "VPC", "vpc", "vpc", "vpc"},
		{"VPC", "VPC", "vpc", "vpc", "vpc"},
		{"Vpce", "VPCE", "vpce", "vpce", "vpce"},
		{"VpcEndpoint", "VPCEndpoint", "vpcEndpoint", "vpc_endpoint", "vpcendpoint"},
		{"Xss", "XSS", "xss", "xss", "xss"},
